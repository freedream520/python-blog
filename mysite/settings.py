...
# MYSQL_PORT = '3307'
# MYSQL_USER = 'mow40w0jnm'
# MYSQL_PASS = 'iwkkzkh0wxmm352k3xjh0xm0z55hmyhxmmhhz0zz'
# MYSQL_DB   = 'app_swxyblog'
...
ROOT_STATIC = os.path.join(os.path.dirname(__file__), '../static')  # up one level from settings.py
...
if 'SERVER_SOFTWARE' in os.environ:
    ...
    STATICFILES_DIRS = (
        ...
        # os.path.join(ROOT_PATH, './blog/static'),
        # ROOT_STATIC,
    )
else:
    STATIC_ROOT = ''
...
SECRET_KEY = 'hxdvxlt4viaf551t@nisvpkuhs9wn8ok#kb#yyti6z5_7+s-!j'
