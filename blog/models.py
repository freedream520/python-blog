...
class Article(models.Model):
    ...
    category = models.ForeignKey(Category, verbose_name=_(u'Categories'), help_text=_(u' '), null=True,
                                        blank=True)
    ...
    def save(self):
        self.content_markup = markdown(self.content_markdown, extensions=['codehilite'])
    ...
    def text_to_html(self):
        return markdown(self.content_markdown, extensions=['codehilite'])
